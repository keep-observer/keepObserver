...
module.exports = {
    ...
    'monitor/htmlElementActive': "./src/services/monitor/htmlElementActive/index.ts",
    'report/kibanaApm': "./src/services/report/kibanaApm/index.ts",
    'middleware/kibanaApmTrack': "./src/services/middleware/kibanaApmTrack/index.ts",
    //暂未完成
    // "analyse/simpleH5": "./src/services/analyse/simpleH5/index.ts",
    // 'monitor/error': "./src/services/monitor/error/index.ts",
